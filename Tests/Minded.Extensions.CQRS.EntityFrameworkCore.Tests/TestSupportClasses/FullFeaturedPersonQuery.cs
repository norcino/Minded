...
{
    /// <summary>
    /// A comprehensive query class for Person entities that implements all available query traits.
    ...
    /// </remarks>
    internal class FullFeaturedPersonQuery : IQuery<IEnumerable<Person>>,
        ICanOrderBy,
        ICanExpand,
        ICanFilterExpression<Person>,
        ICanSkip,
        ICanTop,
        ICanCount
    {
        ...
        /// Example: new[] { "Vehicles", "Vehicles.Maker" }
        /// </summary>
        ...
        /// Example: p => p.Name == "John"
        /// </summary>
        public Expression<Func<Person, bool>> Filter { get; set; }
        #endregion
