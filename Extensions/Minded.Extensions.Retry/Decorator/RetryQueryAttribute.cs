...
{
    /// <summary>
    /// Attribute used by RetryQueryHandlerDecorator to determine if a query requires retry logic.
    ...
    public class RetryQueryAttribute : Attribute
    {
        ...
        /// <summary>
        /// Initializes a new instance of the RetryQueryAttribute with default settings.
        /// </summary>
        public RetryQueryAttribute()
        {
        }

        /// <summary>
        /// Initializes a new instance of the RetryQueryAttribute with specified retry count.
        /// </summary>
        /// <param name="retryCount">Number of retry attempts before failing</param>
        public RetryQueryAttribute(int retryCount)
        {
            RetryCount = retryCount;
        }

        /// <summary>
        /// Initializes a new instance of the RetryQueryAttribute with retry count and delay.
        /// </summary>
        /// <param name="retryCount">Number of retry attempts before failing</param>
        /// <param name="delay1">Delay in milliseconds before retries (used for all retries if no other delays specified)</param>
        public RetryQueryAttribute(int retryCount, int delay1)
        {
            RetryCount = retryCount;
            Delay1 = delay1;
        }
        ...
        /// <summary>
        /// Initializes a new instance of the RetryQueryAttribute with retry count and multiple delays.
        /// </summary>
        /// <param name="retryCount">Number of retry attempts before failing</param>
        ...
        public RetryQueryAttribute(int retryCount, int delay1, int delay2, int delay3 = 0, int delay4 = 0, int delay5 = 0)
        {
            RetryCount = retryCount;
            Delay1 = delay1;
            Delay2 = delay2;
