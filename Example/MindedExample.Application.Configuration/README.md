...
- **MindedExample.Infrastructure.Configuration** - Shared configuration services (`RuntimeConfigurationStore`, `ConfigurationMetadataProvider`)
- **MindedExample.Domain** - Entity models (`ConfigurationEntry`, `UpdateConfigurationRequest`)
...
### E2E Tests
Located in `Tests/MindedExample.Api.E2ETests/ConfigurationE2ETests.cs`:
- GET all configurations
...
- **Configuration Metadata**: [../MindedExample.Infrastructure.Configuration/ConfigurationMetadataProvider.cs](../MindedExample.Infrastructure.Configuration/ConfigurationMetadataProvider.cs)
- **Runtime Configuration Store**: [../MindedExample.Infrastructure.Configuration/RuntimeConfigurationStore.cs](../MindedExample.Infrastructure.Configuration/RuntimeConfigurationStore.cs)
