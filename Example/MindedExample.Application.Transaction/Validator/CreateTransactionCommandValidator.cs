...
namespace MindedExample.Application.Transaction.Validator
{
    ...
    {
        private readonly IValidator<MindedExample.Domain.Transaction> _categoryValidator;
        private readonly IMediator _mediator;

        public CreateTransactionCommandValidator(IValidator<MindedExample.Domain.Transaction> categoryValidator, IMediator mediator)
        {
