...
{
    /// <summary>
    /// Validator for <see cref="RejectTenantJoinRequestCommand"/>.
    /// Ensures the join request exists in the current tenant and has not yet been processed.
    /// </summary>
    public class RejectTenantJoinRequestCommandValidator : ICommandValidator<RejectTenantJoinRequestCommand>
    {
        private readonly IMindedExampleContext _context;
        private readonly ICurrentUserAccessor _currentUserAccessor;

        /// <summary>
        /// Initializes a new <see cref="RejectTenantJoinRequestCommandValidator"/>.
        /// </summary>
        public RejectTenantJoinRequestCommandValidator(IMindedExampleContext context, ICurrentUserAccessor currentUserAccessor)
        {
            _context = context;
        ...
        /// <inheritdoc />
        public async Task<IValidationResult> ValidateAsync(RejectTenantJoinRequestCommand command)
        {
