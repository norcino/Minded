...
{
    [ValidateCommand]
    [RequirePermissions(MindedExample.Domain.Permissions.CanCreateRole)]
    public class CreateRoleCommand : ICommand, ILoggable
    {
        public string RoleName { get; }

        public CreateRoleCommand(string roleName, Guid? traceId = null)
        {
            RoleName = roleName;
